...
export function buildSemanticTokenColors(
  ...
  return {
    ...
    'method.declaration': adjustChroma(colors.function, 1.05),
    ...
    'type.defaultLibrary': { foreground: colors.sandstone, fontStyle: 'italic' },
    'interface.defaultLibrary': { foreground: adjustChroma(colors.type, 0.9), fontStyle: 'italic' },
    'property.defaultLibrary': { foreground: colors.variable, fontStyle: 'italic' },
    'enum.defaultLibrary': { foreground: colors.type, fontStyle: 'italic' },
    'namespace.defaultLibrary': { foreground: colors.namespace, fontStyle: 'italic' },
