...
export function buildEditorColors(colors: BaseColors, mode: Mode, syntax?: SyntaxColors, variant: Variant = 'default'): Record<string, string> {
  ...
  return {
    ...
    'editorBracketHighlight.foreground2': hex(isLight ? 0.42 : 0.68, 0.10, 180),
    'editorBracketHighlight.foreground3': hex(isLight ? 0.48 : 0.72, 0.12, 70),
    ...
    // ── Bracket pair guides ──────────────────────────────────────
    'editorBracketPairGuide.activeBackground1': withOpacity(hex(isLight ? 0.50 : 0.70, 0.14, 28), 0.3),
    'editorBracketPairGuide.activeBackground2': withOpacity(hex(isLight ? 0.42 : 0.68, 0.10, 180), 0.3),
    'editorBracketPairGuide.activeBackground3': withOpacity(hex(isLight ? 0.48 : 0.72, 0.12, 70), 0.3),
    'editorBracketPairGuide.activeBackground4': withOpacity(hex(isLight ? 0.42 : 0.66, 0.10, 140), 0.3),
    'editorBracketPairGuide.background1': withOpacity(hex(isLight ? 0.50 : 0.70, 0.14, 28), 0.1),
    'editorBracketPairGuide.background2': withOpacity(hex(isLight ? 0.42 : 0.68, 0.10, 180), 0.1),
    'editorBracketPairGuide.background3': withOpacity(hex(isLight ? 0.48 : 0.72, 0.12, 70), 0.1),
    'editorBracketPairGuide.background4': withOpacity(hex(isLight ? 0.42 : 0.66, 0.10, 140), 0.1),
    ...
    'terminal.ansiMagenta': hex(isLight ? 0.52 : 0.72, 0.12, 350),
    'terminal.ansiCyan': hex(isLight ? 0.42 : 0.72, 0.10, 180),
