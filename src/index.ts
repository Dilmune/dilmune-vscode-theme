...
const themeConfigs: ThemeConfig[] = [
  ...
  { name: 'Dilmune Dim', fileName: 'dilmune-dim', mode: 'dim', variant: 'default', type: 'dark' },
  { name: 'Dilmune Dim Muted', fileName: 'dilmune-dim-muted', mode: 'dim', variant: 'muted', type: 'dark' },
  { name: 'Dilmune Dim High Contrast', fileName: 'dilmune-dim-high-contrast', mode: 'dim', variant: 'high-contrast', type: 'hc-black' },
  { name: 'Dilmune Dim Warm', fileName: 'dilmune-dim-warm', mode: 'dim-warm', variant: 'default', type: 'dark' },
  { name: 'Dilmune Dim Warm Muted', fileName: 'dilmune-dim-warm-muted', mode: 'dim-warm', variant: 'muted', type: 'dark' },
  { name: 'Dilmune Dim Deep', fileName: 'dilmune-dim-deep', mode: 'dim-deep', variant: 'default', type: 'dark' },
  { name: 'Dilmune Dim Deep Muted', fileName: 'dilmune-dim-deep-muted', mode: 'dim-deep', variant: 'muted', type: 'dark' },
